...
down_stack_filters = [64,128,256,512,512+64]
KERNEL_SIZE = 3
...
if load_from_epoch is not None:
    model = keras.models.load_model(f"conv_classifier_save_at_{load_from_epoch}.tf")
else:
...
#exit()
callbacks = [
    keras.callbacks.ModelCheckpoint("conv_classifier_save_at_{epoch}.tf")
]
